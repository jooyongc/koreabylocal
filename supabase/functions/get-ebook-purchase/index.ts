...
// Looks up a purchase by its Polar Checkout id. `ebook_purchases` has no
// public SELECT policy, so EbookSuccessPage polls this instead of querying
// the table directly — it hands back only what the success page needs
// (never the buyer's payment details).
