...
const CATEGORIES: {
  ...
  { icon: BookOpen, label: "Read the Magazine", desc: "Local stories & city guides", count: "1,284", color: "#12184a", to: "/guidebook" },
  ...
  { icon: ShoppingBag, label: "Shop", desc: "Prints & goods affiliate", count: "300+", color: "#ff2e97", to: "/shop" },
